    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.peserta.update", [$pesertum->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jenis_kelamin') ? 'is-invalid' : '' }}" type="text" name="jenis_kelamin" id="jenis_kelamin" value="{{ old('jenis_kelamin', $pesertum->jenis_kelamin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomor_ponsel') ? 'is-invalid' : '' }}" type="text" name="nomor_ponsel" id="nomor_ponsel" value="{{ old('nomor_ponsel', $pesertum->nomor_ponsel) }}">
