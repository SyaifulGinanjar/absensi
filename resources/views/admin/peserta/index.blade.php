...
@can('pesertum_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.peserta.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.pesertum.title_singular') }}
            </a>
            <button class="btn btn-warning" data-toggle="modal" data-target="#csvImportModal">
                {{ trans('global.app_csvImport') }}
            </button>
            @include('csvImport.modal', ['model' => 'Pesertum', 'route' => 'admin.peserta.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.pesertum.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Pesertum">
            <thead>
                <tr>
                    <th width="10">
...
@can('pesertum_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.peserta.massDestroy') }}",
